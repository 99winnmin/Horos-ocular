...
transcribe.start_transcription_job(
    TranscriptionJobName=jn, # username +
...
transcribe_text2 = literal_eval(rst)['results']

indexed_data = {'_id':'id', 'data':transcribe_text2}

collection_name.insert_one(indexed_data)

# print('results_items : ',type(transcribe_text))
pprint('results : ',indexed_data)